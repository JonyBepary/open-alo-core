...
def main() -> int:
    ...
    from open_alo_core import detect_session_type, is_portal_available, is_wayland
    ...
    from open_alo_core import Point, Rect, Size, WindowInfo
    ...
    try:
        with UnifiedRemoteDesktop() as remote:
            ...
            if frame:
                ...
                print(
                    "   Note: get_frame() is non-blocking, use capture_screenshot() for guaranteed capture"
                )
            print()
